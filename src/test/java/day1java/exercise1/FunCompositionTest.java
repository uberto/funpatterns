...
public class FunCompositionTest {
    ...
    static String pad(String s) {return  " " + s; }
    static String mirror(String s) {return  s + new StringBuilder(s).reverse().toString(); }
    static int strLen(String s) {return  s.length(); }
